...
for i in range(nbrun):
    ...
    corr_theta_mod,cosine_theta_mod,KL_theta_mod,corr_phi_mod,cosine_phi_mod,KL_phi_mod,corr_gamma_mod=gibbs_expertise(X,p_generate,theta_generate,phi_generate,zeta,gamma_generate)
