...
@author: mikap
"""
def gibbs_vanilla(X,p_generate,theta_generate,phi_generate,num_topics,num_docs):
    ...
    return v_phi,corr_theta,cosine_theta,KL_theta,corr_phi,cosine_phi,KL_phi
#    plt.clf()
